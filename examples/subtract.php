...
// Load two modules
$moduleA = new WasmModule($engine, __DIR__ . "/subtract.wasm");  // exports a function `add` and a memory
echo "Module subtract.wasm loaded\n";
...
$result = $instanceA->call("subtract", [15, 10]);
var_dump($result);
